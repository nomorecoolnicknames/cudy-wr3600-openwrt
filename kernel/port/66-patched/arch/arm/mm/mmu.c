...
/* BCM96764 bring-up: stage marker via the periph section mapping (DEBUG_LL
 * early section before devicemaps_init, mdesc->map_io section after). */
static void __init bcm96764_pi_mark(u8 stage)
{
...
#else
static inline void bcm96764_pi_mark(u8 s) {}
#endif
void __init paging_init(const struct machine_desc *mdesc)
{
	bcm96764_pi_mark(0x40);
	void *zero_page;
	...
	prepare_page_table();
	bcm96764_pi_mark(0x41);
	map_lowmem();
	bcm96764_pi_mark(0x42);
	memblock_set_current_limit(arm_lowmem_limit);
	bcm96764_pi_mark(0x43);
	...
	bcm96764_pi_mark(0x44);
	early_fixmap_shutdown();
	bcm96764_pi_mark(0x45);
	devicemaps_init(mdesc);
	bcm96764_pi_mark(0x46);
	kmap_init();
	bcm96764_pi_mark(0x47);
	tcm_init();
	bcm96764_pi_mark(0x48);
